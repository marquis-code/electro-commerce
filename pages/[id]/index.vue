          ...
          <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
            ...
            <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
              <h1 class="text-3xl font-bold tracking-tight text-gray-900">
                DEYE 16kw/48v Hybrid inverters 3phase
              </h1>
              ...
              <div class="mt-6 space-y-5">
                <p class="space-x-3">categories: <span class="text-gray-400">Inverters</span></p>
                <p class="space-x-3">Availablity: <span class="text-green-700">in stock</span></p>
                <p>Product by: DEYE</p>
                <p class="text-red-500 font-medium">CFA6,259,275</p>
              </div>
            ...
            >
              ...
              <button
                class="inline-block px-4 text-gray-700 hover:bg-gray-50 focus:relative"
                title="View Orders"
              >
                <svg
                  class="h-6 w-6"
              ...
              <section class="flex items-center gap-x-3">
                  ...
                  <div class="rounded-full">
                      ...
                      <button type="button" class="size-10 px-3 leading-10 text-gray-600 transition hover:opacity-75">
                          &minus;
                      </button>
                      ...
                      <input
                          ...
                          id="Quantity"
                          value="1"
                          class="h-10 w-16 border-transparent outline-none text-center [-moz-appearance:_textfield] sm:text-sm [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"
                      />
                  ...
                  <a
                  class="group flex items-center justify-between gap-4 rounded-full border border-current px-2 py-1.5 text-indigo-600 transition-colors hover:bg-indigo-600 focus:outline-none focus:ring active:bg-indigo-500"
                  href="#"
              >
                  <span
                  class="font-medium text-sm transition-colors group-hover:text-white"
                  >
                  Add to cart
                  </span>
              ...
              >
                  ...
                  <path
                      class="cls-1"
                      d="M28.11,13.25l-2,9.75-.16.75A1.81,1.81,0,0,1,24.05,25H10V24s-1.55-1-1-1H22.71a1,1,0,0,0,1-.78L26.16,11.5h.09C27.42,11.5,28.31,12.33,28.11,13.25Z"
                  />
  
                  <path
                      d="M24.05,25.6H11.2a2.41,2.41,0,0,1-2.45-1.73L6,10.9H26.25a2.64,2.64,0,0,1,2.06.91,1.85,1.85,0,0,1,.39,1.57l-2.2,10.5A2.41,2.41,0,0,1,24.05,25.6ZM7.51,12.1,9.93,23.63a1.25,1.25,0,0,0,1.27.77H24.05a1.25,1.25,0,0,0,1.27-.77l2.2-10.51a.6.6,0,0,0-.14-.55,1.48,1.48,0,0,0-1.13-.47Z"
                  />
  
                  <path
                      d="M6.77,12.1a.6.6,0,0,1-.56-.39L5.42,9.6H3A.6.6,0,0,1,3,8.4H5.83a.59.59,0,0,1,.56.39l1,2.5a.6.6,0,0,1-.35.77A.57.57,0,0,1,6.77,12.1Z"
                  />
  
                  <path
                      d="M10.5,29.1a1.6,1.6,0,1,1,1.6-1.6A1.6,1.6,0,0,1,10.5,29.1Zm0-2a.4.4,0,1,0,.4.4A.4.4,0,0,0,10.5,27.1Z"
                  />
  
                  <path
                      d="M24.5,29.1a1.6,1.6,0,1,1,1.6-1.6,1.67,1.67,0,0,1-.22.81A1.61,1.61,0,0,1,24.5,29.1Zm0-2a.4.4,0,0,0-.4.4.41.41,0,0,0,0,.19.4.4,0,0,0,.69,0,.39.39,0,0,0,.06-.2A.4.4,0,0,0,24.5,27.1Z"
                  />
                  </g>
              </svg>
                  </span>
              ...
              <a
                  class="inline-block rounded-full border border-indigo-600 bg-indigo-600 p-2 text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
                  href="#"
              >
              ...
              <a
                  class="inline-block rounded-full border border-indigo-600 p-2 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                  href="#"
              >
                  <svg
                  class="h-4 w-4"
                  ...
                  >
                  <path
                      d="M812.8 665.6L413.866667 512l398.933333-153.6c32-12.8 49.066667-49.066667 36.266667-83.2-12.8-32-49.066667-49.066667-83.2-36.266667l-554.666667 213.333334C187.733333 460.8 170.666667 486.4 170.666667 512s17.066667 51.2 40.533333 59.733333l554.666667 213.333334c8.533333 2.133333 14.933333 4.266667 23.466666 4.266666 25.6 0 49.066667-14.933333 59.733334-40.533333 12.8-34.133333-4.266667-70.4-36.266667-83.2z"
                      fill="#1976D2"
                  />
                  <path
                      d="M234.666667 512m-149.333334 0a149.333333 149.333333 0 1 0 298.666667 0 149.333333 149.333333 0 1 0-298.666667 0Z"
                      fill="#1E88E5"
                  />
                  <path
                      d="M789.333333 298.666667m-149.333333 0a149.333333 149.333333 0 1 0 298.666667 0 149.333333 149.333333 0 1 0-298.666667 0Z"
                      fill="#1E88E5"
                  />
                  <path
                      d="M789.333333 725.333333m-149.333333 0a149.333333 149.333333 0 1 0 298.666667 0 149.333333 149.333333 0 1 0-298.666667 0Z"
                      fill="#1E88E5"
                  />
                  </svg>
              </a>
