globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/devalue/index.js';
import { renderSSRHead } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/marquis.abah/ChineduEcommerce/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/marquis.abah/ChineduEcommerce/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquis.abah/ChineduEcommerce","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquis.abah/ChineduEcommerce/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquis.abah/ChineduEcommerce/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquis.abah/ChineduEcommerce/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marquis.abah/ChineduEcommerce/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_ZTsq6X = () => Promise.resolve().then(function () { return renderer$1; });
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"ElectroCommerce","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/marquis.abah/ChineduEcommerce/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
